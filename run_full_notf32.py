#!/usr/bin/env python
"""
Run FULL training with TF32 disabled to avoid CUBLAS errors
"""
import torch
import os
...
print("=" * 80)
print("FULL TRAINING - TF32 DISABLED FOR CUBLAS COMPATIBILITY")
print("=" * 80)
...
@hydra.main(config_path="config", config_name="train_fauna_mouse_dannce", version_base=None)
